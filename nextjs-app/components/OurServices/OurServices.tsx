...
export const OurServices = () => {
  return (
    <div id="our-services" className="w-full lg:h-screen p-2">
            ...
            <div className="grid gap-4 justify-center items-center">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-center pt-4">
                  After accepting our no-obligation cash offer, we can close in
                  as little as 5 days. No hidden fees. No repairs necessary.
                </p>
              </div>
            </div>
          </div>
          <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-1 gap-4 justify-center items-center">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-center pt-4">
                  We can provide you temporary housing after you sell your home
